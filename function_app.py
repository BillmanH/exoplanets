...
@azapp.function_name(name="resolveActionEvents")
@azapp.event_hub_message_trigger(arg_name="event",
...
@azapp.function_name(name="actionResolverTimer")
@azapp.schedule(schedule="0 */2 * * * *", 
              arg_name="mytimer",
              run_on_startup=True) 
...
@azapp.function_name(name="ututimer")
@azapp .schedule(schedule="0 */2 * * * *", 
              arg_name="mytimer",
              run_on_startup=True) 
def test_function(mytimer: func.TimerRequest) -> None:
